---
title: "Tutorial on Causality - Nordic Prob AI 2024"
...
Plotting the true causal diagram, just for reference
...
Checking identifiability of P(y\|do(x)) through  Backdoor Adjustment / Generalized Adjustment Criterion (GAC).
...
4.  What can it happen with a smaller sample size? Change the seed to see how the results vary.
...
Note: IDP does not simplifies the expression by leveraging conditional independencies. By doing so, we would see the equivalence with the usual adjustment formula.
